...
#ifndef PIC24_I2C2_R7_H
#define	PIC24_I2C2_R7_H
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
    ...
    #define I2C2_NAK        1 ;
    #define I2C2_TIME_OUT2  2 ;
    #define I2C2_TIME_OUT3  3 ;
    #define I2C2_TIME_OUT4  4 ;
    #define I2C2_TIME_OUT5  5 ;
 ...
 *  FOrmat:
 *  76543210
 *  ccccffffssss    where c=count, f=fault, s=section
 *  000000000000    SUCCESS
 *  0000ffff0001    I2C2 Start bit
 *          0010    I2C2 Send Address-Write (often occurs if no response from slave).
 *  ccccffff0011    I2C2 Send String
 *          0100    I2C2 Restart
 ...
 *  ffff0011        TimeOut #2
 *  ffff0100        TimeOut #3
 *  ffff0101         (Not Defined Yet)
 *  ffff0110         (Not Defined Yet)
 *  ffff0111         (Not Defined Yet)
 *  1000         (Not Defined Yet)
 *  1001         (Not Defined Yet)
 *  1010         (Not Defined Yet)
 *  1011         (Not Defined Yet)
