...
signed long SNS_Temerature   ;
signed long SNS_Pressure     ;
signed long SNS_Humidity     ;

signed long Raw_Temerature   ;
...
int THP_Init (void)
{   int THP_stat = 0 ;
    THP_stat= i2c2_TalkToDevice(THP_Addr, THP_Cfg3L4,THP_Cfg3S4,THP_Cfg3L4,THP_Data)    ;
    return (THP_stat)     ;
}
...
unsigned long THP_compensate_H_int32(signed long adc_H)
 {  signed long v_x1_u32r;
    ...
    v_x1_u32r = (((((adc_H << 14) - (((signed long)ConfigParams.dig_H4) << 20) - 
                   (((signed long)ConfigParams.dig_H5) * v_x1_u32r)) + 
                   ((signed long)16384)) >> 15) * 
                (((((((v_x1_u32r * ((signed long)ConfigParams.dig_H6)) >> 10) * 
                   (((v_x1_u32r * ((signed long)ConfigParams.dig_H3)) >> 11) + 
                   ((signed long)32768))) >> 10) + ((signed long)2097152)) * 
                   ((signed long)ConfigParams.dig_H2) + 8192) >> 14));
    v_x1_u32r = (v_x1_u32r - (((((v_x1_u32r >> 15) * 
                (v_x1_u32r >> 15)) >> 7) * ((signed long)ConfigParams.dig_H1)) >> 4));
...
{     THP_LoadConfigs () ;
   // $ $ $ CORRECT SIGN   
     // Pressure      = 0b00000000MMMMMMMMLLLLLLLLXXXX0000 ;
      ...
      Raw_Temerature =  (Combine3(THP_Data[3], THP_Data[4], THP_Data[5])) >> 4 ;
