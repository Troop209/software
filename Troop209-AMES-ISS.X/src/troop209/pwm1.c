...
static void turnOnRawPwm1(unsigned period, unsigned dutycycle)
{
    ...
    OC1RS = period;
    OC1R = dutycycle;  // round(((unsigned long)(period) * dutycycle) / 100.00);
    OC1CON1 |= 0x0006;
...
const PWMA pwma1 = {turnOn:turnOnRawPwm1, turnOff:turnOffRawPwm1, init:initRawPwm1},
           pwma2 = {turnOn:turnOnRawPwm2, turnOff:turnOffRawPwm2, init:initRawPwm2};
