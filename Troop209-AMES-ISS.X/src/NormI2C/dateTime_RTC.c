...
{
    // RTC_I2C_TimeStamp = {"00.01.01-00:00:00"};

    CalendarAndClock timeStamp = getSystemCalendarAndClock();

    RTC_I2C_TimeStamp[0]  = '0' + timeStamp.tensOfYears;
    RTC_I2C_TimeStamp[1]  = '0' + timeStamp.years;
    RTC_I2C_TimeStamp[3]  = '0' + timeStamp.tensOfMonths;
    RTC_I2C_TimeStamp[4]  = '0' + timeStamp.months;
    RTC_I2C_TimeStamp[6]  = '0' + timeStamp.tensOfDays;
    RTC_I2C_TimeStamp[7]  = '0' + timeStamp.days;
    RTC_I2C_TimeStamp[9]  = '0' + timeStamp.tensOfHours;
    RTC_I2C_TimeStamp[10] = '0' + timeStamp.hours;
    RTC_I2C_TimeStamp[12] = '0' + timeStamp.tensOfMinutes;
    RTC_I2C_TimeStamp[13] = '0' + timeStamp.minutes;
    RTC_I2C_TimeStamp[15] = '0' + timeStamp.tensOfSeconds;
    RTC_I2C_TimeStamp[16] = '0' + timeStamp.seconds;
...
{   // Returns point if stat == 0 else returns null ptr
     ...
     char   RTC_I2C_String[8] = {0,0,0,0,0,0,0,0}     ;  // s,m,h,dw,d,m,y
//     
    int stat = 0    ;
    // Copy passed TimeStamp into I2C RTC BCD format
    // Then send to I2C RTC and 
    // return Status of I2C transaction
    
    RTC_I2C_String[0] = 0   ;   // register Address    
    RTC_I2C_String[1] = (((int) RTC_I2C_TimeStamp[15] - '0') << 4) + ((int) RTC_I2C_TimeStamp[16] - '0')  ;   // Seconds
    RTC_I2C_String[2] = (((int) RTC_I2C_TimeStamp[12] - '0') << 4) + ((int) RTC_I2C_TimeStamp[13] - '0')  ;   // Minutes
    RTC_I2C_String[3] = (((int) RTC_I2C_TimeStamp[9]  - '0') << 4) + ((int) RTC_I2C_TimeStamp[10] - '0')  ;    // Hours
    RTC_I2C_String[4] = 0   ; // DayOfWeek
    RTC_I2C_String[5] = (((int) RTC_I2C_TimeStamp[6]  - '0') << 4) + ((int) RTC_I2C_TimeStamp[7]  - '0')  ;     // Day
    RTC_I2C_String[6] = (((int) RTC_I2C_TimeStamp[3]  - '0') << 4) + ((int) RTC_I2C_TimeStamp[4]  - '0')  ;     // Month
    RTC_I2C_String[7] = (((int) RTC_I2C_TimeStamp[0]  - '0') << 4) + ((int) RTC_I2C_TimeStamp[1]  - '0')  ;     // Year
     
    stat=i2c2_TalkToDevice(0x68, 8, RTC_I2C_String,  0, NullPtr) ;
    return (stat)       ;
}
   
int getI2C2_RTCTime(char *RTC_I2C_TimeStamp)
{       // Get Time from I2C RTC and format time stamp
    // char    RTC_I2C_TimeStamp[18]   ;
    char   RTC_I2C_String[8] = {0,0,0,0,0,0,0,0}     ;  // s,m,h,dw,d,m,y
    char   RTM_I2C_RegAdr  =  0x00    ;
    int stat = 0    ;
...
void setPIC_RTCTime(char *RTC_I2C_TimeStamp)
{
    ...
    cc.tensOfYears   = RTC_I2C_TimeStamp[0] - '0' ;
    cc.years         = RTC_I2C_TimeStamp[1] - '0' ;
    cc.tensOfMonths  = RTC_I2C_TimeStamp[3] - '0' ;
    cc.months        = RTC_I2C_TimeStamp[4] - '0' ;
    cc.tensOfDays    = RTC_I2C_TimeStamp[6] - '0' ;
    cc.days          = RTC_I2C_TimeStamp[7] - '0' ;
    cc.tensOfHours   = RTC_I2C_TimeStamp[9] - '0' ;
    cc.hours         = RTC_I2C_TimeStamp[10] - '0' ;
    cc.tensOfMinutes = RTC_I2C_TimeStamp[12] - '0' ;
    cc.minutes       = RTC_I2C_TimeStamp[13] - '0' ;
    cc.tensOfSeconds = RTC_I2C_TimeStamp[15] - '0' ;
    cc.seconds       = RTC_I2C_TimeStamp[16] - '0' ;
...
//    //.cmp = compareDateAndTime,  //--Harmon commented.
