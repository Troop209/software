...
${OBJECTDIR}/_ext/1464792115/AltTemp.o: ../../src/NormI2C/AltTemp.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/1464792115" 
	@${RM} ${OBJECTDIR}/_ext/1464792115/AltTemp.o.d 
	@${RM} ${OBJECTDIR}/_ext/1464792115/AltTemp.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  ../../src/NormI2C/AltTemp.c  -o ${OBJECTDIR}/_ext/1464792115/AltTemp.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/_ext/1464792115/AltTemp.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1    -omf=elf -fast-math -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mlarge-code -mlarge-data -mlarge-scalar -O0 -I"../../src/core" -I"../../src/dev" -I"../../src/mdd" -I"../../src/usb" -msmart-io=1 -Wall -msfr-warn=off  
	@${FIXDEPS} "${OBJECTDIR}/_ext/1464792115/AltTemp.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
